...
const Header = () => {
  ...
  return (
    <header
      className={`fixed right-4 left-4 md:left-20 md:right-20 xl:left-20 xl:right-20 top-4 z-99999 w-auto py-5 shadow-lg rounded-lg ${
        stickyMenu
                    ...
                    <Link
                      ...
                      className={`relative ${
                        pathUrl === menuItem.path
                          ? "text-primary font-bold after:content-[''] after:absolute after:left-0 after:right-0 after:bottom-[-4px] after:h-[2px] after:bg-[#5FC3F7] after:w-full"
                          : "hover:text-primary"
                      }`}
                    >
                      {menuItem.title}
